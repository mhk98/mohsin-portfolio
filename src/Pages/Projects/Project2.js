...
{/* <div class="flex justify-center w-full py-2 gap-2">
  ...
  <a href="#item3" class="btn btn-xs">3</a> 
      ...
      <div className='text-left mt-8'>
            <li>Email verification after google sign in and sign up with email password.</li>
        ...
        <div className='mt-4'>
        <button className='btn border-2 border-primary mr-4'><a target='_blank' href='https://x-autos-warehouse.web.app/'>Live Website</a> </button>
        <button className='btn border-2 border-primary mr-4'><a target='_blank' href='https://github.com/mhk98/warehouse-management-client-side'>Client Code</a> </button>
        <button className='btn border-2 border-primary'><a target='_blank' href='https://github.com/mhk98/warehouse-management-server-side'>Server Code</a> </button>
        </div>
