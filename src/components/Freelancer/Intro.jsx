      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-5 valign md-hide">
            <h2 className="max-text" data-text=" MERN Fullstack Developer.">
              {" "}
          ...
          <div className="col-lg-3 valign order1">
            <div className="text-qoute">
              <span className="exp mb-30 main-bg">
                More Than 1 Year Of Experience
              </span>
              <p>
                I'm Creative Independent Web Developer, and I'm very passionate
                and dedicated to my work, Using year-over-year design approaches
