          ...
          <div className="col-lg-5 offset-lg-1 valign">
            <div className="exp-items full-width">
              <div className="item d-flex pb-30 pt-30 mb-30 bord-thin-top bord-thin-bottom">
                <div className="title">
                  <h6>Project Management Technology </h6>
                  <p className="fz-12">Junior Fullstack Developer (MERN)</p>
                </div>
                <div className="date ml-auto text-right">
                  ...
                  <p className="fz-12">2022 - 2023</p>
                </div>
              </div>
              <div className="item d-flex pb-30 mb-30 bord-thin-bottom">
                <div className="title">
                  <h6>Tread Link Ltd.</h6>
                  <p className="fz-12">Fullstack Developer</p>
                </div>
                <div className="date ml-auto text-right">
                  <span className="icon">
                    <Link href="/dark/page-about">
                  ...
                  <p className="fz-12">2023 - Continue</p>
                </div>
              </div>
            </div>
          </div>
