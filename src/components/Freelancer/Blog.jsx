...
//= Data
import data from "@/data/Freelancer/blog.json";
        ...
        <div className="sec-lg-head mb-80">
          <div className="row">
            <div className="col-lg-7">
              <h6 className="dot-titl-non mb-10">Our Blog</h6>
              <h2 className="fz-50">Latest Blog</h2>
            </div>
        ...
        <div className="row">
          {data.map((item, index) => (
            <div className="col-lg-6" key={item.id}>
              <div
                className={`item ${index !== data.length - 1 ? "md-mb80" : ""}`}
              >
                  ...
                  <div className="col-md-6 valign">
                    <div className="cont">
                      ...
                      <div className="tags colorbg mt-15">
                        {item.tags.map((tag, i) => (
                          <Link href="" className="me-1" key={tag}>
                            {tag}
                          </Link>
                        ))}
                      </div>
