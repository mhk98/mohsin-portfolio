          ...
          <ul className="navbar-nav">
            ...
            >
              ...
              <ul className="dropdown-menu">
                ...
                <li>
                  <Link className="dropdown-item" href="/dark/portfolio-metro">
                    Portfolio Metro
                  </Link>
                </li>
                <li>
                  <Link className="dropdown-item" href="/dark/portfolio-modern">
                    Modern Grid
                  </Link>
                </li>
                <li>
                  <Link className="dropdown-item" href="/dark/project-details1">
                    Project Details 1
                  </Link>
                </li>
                <li>
                  <Link className="dropdown-item" href="/dark/project-details2">
                    Project Details 2
                  </Link>
                </li>
              </ul>
